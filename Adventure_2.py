...
# Continue on your journey
    ...
    if player_choice == 1:
        ...
        battle_outcome = random.choice(["win", "lose"]) # Randomly determine win or lose
        ...
        if battle_outcome == "win":
            ...
            if puzzle_choice == "1": # Correct answer
                ...
                if guardian_choice == "1":
                    ...
                    print("\n--- VICTORY! ---")
                    print("You have successfully navigated the trials and reached the sacred kingdom! Your legend will be sung for generations.")
                    ...
                    print("Invalid choice. The Royal Guardian stares impassively, waiting for a clear answer. As you hesitate, it deems you unworthy.")
                    print("\n--- DEATH ---")
                    return
                ...
                print("\nYou find yourself back at the base of the tree, scratched and annoyed. The symbols still beckon.")
                # You could loop them back to the choices or add another smaller scene here.
                # For this example, let's assume they are now forced to choose a symbol.
                # In a more complex game, you might re-prompt the puzzle choices.
            else:
